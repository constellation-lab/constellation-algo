...
By the default the template creates a single `HelloWorld` contract under constellation_derivative folder in the `smart_contracts` directory. To add a new contract:
